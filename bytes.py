    ...
    while True:
        ...
        if (a % 10 == 0):
            ...
            if (result == True):
                ...
                remove_all()
                print ("Size of each image frame in bytes") 
                for b in arr:
                    print b
                print ("Average file size in bytes")
                print (sum(arr) / len(arr))
                print ("Size of authentication status in bytes ")
                print(os.stat('yes.txt').st_size)
